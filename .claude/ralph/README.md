...
> When asked to generate or update the PRD, please refer to this README for the required format and fields. Output the complete plan as a single valid JSON array, covering all features or user stories needed for the project. Do not output explanations or markdown, only the JSON array. You may copy the example and structure from this README as a template.
